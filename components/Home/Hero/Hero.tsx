    ...
    <section className="relative container mx-auto flex w-full flex-col items-center">
      <div className="mt-[114px] flex h-full min-h-[calc(100vh-114px)] w-full flex-col px-3 lg:flex-row lg:px-0">
        ...
        <div className="flex flex-col justify-center gap-8 lg:w-1/2">
          <h1 className="text-dark-primary font-display z-30 text-4xl lg:text-6xl">
            Private by Design.
            <br />
            Personal by Legacy.
          </h1>
          <p className="hero-text z-30 text-2xl text-white lg:text-4xl">
      ...
      <div className="flex h-full min-h-screen w-full flex-col-reverse px-3 lg:flex-row lg:px-0">
        ...
        <div className="flex flex-col justify-center gap-8 lg:w-1/2">
          <p className="hero-text z-30 text-2xl text-black lg:text-3xl">
          ...
          <h1 className="text-dark-primary font-display z-30 text-4xl lg:text-5xl">
            More than Service.
            <br />
            More than Access.
          </h1>
      ...
      <div className="flex h-full min-h-screen w-full flex-col justify-end px-3 lg:px-0">
        <div className="flex flex-col items-center justify-center gap-8">
          <p className="hero-text z-30 max-w-[1100px] text-center text-2xl text-black lg:text-4xl">
            We are your architects of identity— your private bridge between
            ambition, emotion, and the extraordinary.
          </p>
          <h1 className="text-dark-primary font-display z-30 text-center text-2xl lg:text-6xl">
