...
const Hero: React.FC<Props> = ({ heroSection, sectionThree, sectionTwo }) => {
  ...
  return (
    ...
    >
      ...
      <div className="section-3 flex h-full min-h-screen w-full flex-col justify-end px-3 lg:px-0">
        <div className="flex flex-col items-center justify-center gap-8">
          <p className="section-3-para-1 hero-text z-40 max-w-[800px] text-center text-white lg:text-2xl">
            {sectionThree.paragraph}
          </p>
          <h1 className="section-3-heading-1 text-dark-primary font-display z-40 text-center text-2xl font-bold lg:text-5xl">
